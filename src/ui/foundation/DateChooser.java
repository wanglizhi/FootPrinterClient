...
//      this.add(toSelect,BorderLayout.EAST);
    ...
    private class JP1 extends JPanel{
        ...
        private void initJP1(){
            yearleft=new JLabel("  <<",SwingConstants.CENTER);
            yearleft.setToolTipText("上一年");
            yearright=new JLabel(">>  ",SwingConstants.CENTER);
            ...
            monthleft=new JLabel("  <", SwingConstants.RIGHT);
            monthleft.setToolTipText("上一月");
            monthright=new JLabel(">  ", SwingConstants.LEFT);
            ...
            centercontainer=new JLabel("", SwingConstants.CENTER);
