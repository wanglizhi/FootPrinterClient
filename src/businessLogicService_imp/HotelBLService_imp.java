...
public class HotelBLService_imp extends PlaceBLService_imp{

	public HotelBLService_imp(PlaceDataService placeDataService) {
...
//		}else{
//			image=BasePanel.createFixedSizeImage("img/景点/hotel.png", 300, 240);
//		}
